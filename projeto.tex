...
%====================================
\subsubsection{Modelo de Erdős-Rényi e Gilbert}

Os Modelo de Erdős-Rényi e o Modelo de Gilbert geram redes aleatórias com densidade de conexão variada. Esses dois modelos são bastante estudados e também os mais antigos, os artigos de Gilbert e Erdős-Rényi datam de 1959. Muitos dos valores esperados para suas métricas já estão disponíveis como modelos puramente matemáticos, ou seja, é possível calculá-los sem que seja necessário criar a rede de fato.

Existem dois modelos de redes aleatórias, o primeiro, conhecido como $G(N,L)$ é de Erdős-Rényi e é criado a partir de um número fixo de nós $N$ e conexões $L$. Entretanto, o modelo mais usado é conhecido como $G(N,p)$ proposto por Gilbert, criado a partir de $N$ nós e com probabilidade fixa $p$ de conexão entre dois nós quaisquer. Os modelos são equivalentes em suas propriedades, porém o segundo simplifica o cálculo de algumas características \cite{Barabasi2016-rn}.
