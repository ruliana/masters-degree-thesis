...
%% EU ENTENDO QUE VOCÊ USA MÉTRICA, POIS A LITERATURA USA MÉTRICA, CERTO? SE A LITERATURA NÃO CHAMAR DE MÉTRICA EU CHAMARIA DE MEDIDA, POIS MATEMATICAMENTE UMA MÉTRICA TEM QUE ATENDER AS PROPRIEDADES DE SER DEFINIDAMENTE POSITIVA, SIMÉTRICA, RESPEITAR A DESIGULDADE TRIANGULAR E SER NULA APENAS PARA PONTOS COINCIDENTES. COMO NÓS NÃO VAMOS PROVAR QUE CADA ITEM APRESENTADO AQUI É UMA MÉTRICA, USAR A EXPRESSÃO MEDIDA PODE NOS POUPAR DE IMPRECISÕES MATEMÁTICAS.
...
%% ENTENDO QUE ESSE PARÁGRAFO ACIMA DEVE SAIR DAQUI.
...
%% O PARÁGRAFO ACIMA DEVE SER MOVIDO PARA UMA SEÇÃO ESPECÍFICA
...
Duas propriedades ganharam notoriedade na virada do século com os trabalhos de \citeonline{Watts1998-wt} e \citeonline{Barabasi1999}. Elas geraram um interesse crescente por redes na comunidade científica e culminaram no surgimento de uma novo campo de estudo conhecido como Ciência de Redes \cite{Barabasi2016-rn}.
...
\citeonline{Barabasi2016-rn} especulam que o fato da propriedade de mundo pequeno causar surpresa é por causa da noção de proximidade ser frequentemente associada à distância física, que pode ser modelada como uma rede reticulada e não possui a propriedade de mundo pequeno.
